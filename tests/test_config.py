...
def test_custom_values():
    ...
    assert settings.wyoming_host == "10.0.0.1"
...
def test_from_env():
    ...
    assert settings.wyoming_host == "10.0.0.2"
    assert settings.wyoming_port == 10206
